...
u8	GPIO_u8SetPortValue (u8 Copy_u8Port  , u16 Copy_u16Value)
{
	...
	switch(Copy_u8Port)
	{
		case GPIO_u8_PORTA	:
		{
			CLR_BIT(Copy_u16Value,13);
			CLR_BIT(Copy_u16Value,14);
		...
		case GPIO_u8_PORTB	:
		{
			CLR_BIT(Copy_u16Value,3);
			CLR_BIT(Copy_u16Value,4);
...
void	GPIO_voidSetChannelValue(u8 Copy_u8Port, u8 Copy_u8Pin, u16 Copy_u16Value)
{
	...
	switch(Copy_u8Port)
	{
		case GPIO_u8_PORTA	:
		{
			...
			GPIOA_ODR=((GPIOA_ODR&~0xff)|(Copy_u16Value&0xff));
			break;
		}
		case GPIO_u8_PORTB	:
		{
			...
			GPIOB_ODR=((GPIOB_ODR&~0xff)|(Copy_u16Value&0xff));
			break;
		}
